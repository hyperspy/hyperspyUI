...
release = hyperspyui.__version__
...
exclude_patterns = ["desktop_integration*, user_plugins*, version*"]
...
man_pages = [(master_doc, "hyperspyui", "HyperSpyUI Documentation", [author], 1)]
