...
class Example(QtWidgets.QMainWindow):
    ...
    def initUI(self):
        ...
        color_list = []
        color_list.append(
            ("QtGui.QPalette.Window", self.palette().color(QtGui.QPalette.Window))
        )
        color_list.append(
            (
        ...
        color_list.append(
            (
                "QtGui.QPalette.Foreground",
                self.palette().color(QtGui.QPalette.Foreground),
            )
        )
        color_list.append(
            ("QtGui.QPalette.Base", self.palette().color(QtGui.QPalette.Base))
        )
        color_list.append(
            (
        ...
        color_list.append(
            ("QtGui.QPalette.Text", self.palette().color(QtGui.QPalette.Text))
        )
        color_list.append(
            ("QtGui.QPalette.Button", self.palette().color(QtGui.QPalette.Button))
        )
        color_list.append(
            (
        ...
        for i, f in enumerate(icon_files):
            ico_list[i] = QtGui.QIcon(self.replaceSvgColor(f, "#000000", "red"))
